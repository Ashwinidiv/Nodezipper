...
export const NOTES_DELETE_REQUEST = "NOTE_UPDATE_REQUEST";
export const NOTES_DELETE_SUCCESS = "NOTE_UPDATE_SUCCESS";
export const NOTES_DELETE_FAIL = "NOTE_UPDATE_FAIL";
